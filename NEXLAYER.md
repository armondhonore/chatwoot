...
**Live:** [https://relaxed-weasel-chatwoot.cloud.nexlayer.ai](https://relaxed-weasel-chatwoot.cloud.nexlayer.ai)  

**Runtime:** node · **Port:** 3000 · **Deploy branch:** develop

---

## How this deployment works

**chatwoot** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/chatwoot:9f05a68-fix8"
      path: /
      servicePorts:
        - 3000
      vars: {}
